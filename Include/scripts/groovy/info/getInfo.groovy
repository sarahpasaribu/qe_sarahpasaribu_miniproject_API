...
class getInfo {
	 ...
	 * The step definitions below match with Katalon sample Gherkin steps
	 //	 */
	//		@Given("Get call to https://alta-shop.herokuapp.com/api/auth/info-001")
	//		def getUserInformation() {
	//			println ("\n Get call to https://alta-shop.herokuapp.com/api/auth/info-001")
	//			response = WS.sendRequest(findTestObject('Authentication/TC.Info/Info.001'))
	//		}
	//
	//		@Then("I receive valid HTTP response code 200-002")
	//		def receiveInfoValidResponse200() {
	...
	def getUserInformationInvalid() {
		println ("\n Get call to https://alta-shop.herokuapp.com/api/auth/info-002")
		response = WS.sendRequest(findTestObject('Authentication/TC.Info/Info.002'))
	}

	@Then("I receive valid HTTP response code 404 ")
	def receiveInfoValidResponse404() {

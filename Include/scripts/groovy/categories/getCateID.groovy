...
class getCateID {
	...
	def getCateIDValid() {
		println ("Set method get category by ID to GET-001")
	}
	...
	def showResultGetCateID() {
		println ("Show verify category by ID result 200 OK-001")
	}
	
	
	//INVALID METHOD 
	
	@Given("Set category by ID method to GET-002")
	def getCateIDValid2() {
		println ("Set category by ID method to GET-002")
	}

	@When("Set URL https://alta-shop.herokuapp.com/api/categories-002")
	def getCateIDSetURL2() {
	...
	def showResultGetCateID2() {
		println ("Show verify category by ID result 405 Method Not Allowed-002")
	}

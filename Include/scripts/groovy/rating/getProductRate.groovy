...
class getProductRate {
	...
	def getRatingSetURL() {
		println ("Set URL getRating product https://alta-shop.herokuapp.com/api/products/2/ratings-001")
	}
	
	@And("Send getRating Request-001")
	def getRatingSendRequest() {
		println ("Send getRating Request-001")
	}
	@Then("Show getRating product the verify result 200 OK-001")
	def showResultGetRating() {
		println ("Show getRating product the verify result 200 OK-001")
	}
}